                        ...
                        <div id="browser_default" class="col-lg-12 layout-spacing col-md-6 mt-4">
                            <div class="statbox widget box box-shadow">
                                <div class="widget-header">
                                    <div class="row">
                                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 mt-2">
                                            <h4>Detail Data Mitra - {{ $data->name }} ({{ $data->agent_code }})</h4>
                                        </div>                 
                                    </div>
                                </div>
                                ...
                                <div class="widget-content widget-content-area p-4">
                                    ...
                                    @enderror
                                    <form method="POST" action="{{ route('dashboard.userdata.updateagent',[$data->id]) }}" enctype="multipart/form-data" class="row g-3">
                                    @csrf
                                    @method('PUT')
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-3">
                                            <label for="agen_code" class="form-label">Kode Agen</label>
                                            <input readonly id="agen_code" type="text" class="form-control" name="agen_code" value="{{ $data->agent_code }}" required autocomplete="email">
                                        </div>                                    
                                        <div  class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <label for="target_id" class="form-label">Target Level</label>
                                            <select class="form-select" name="target_id" id="target_id">
                                                <option  selected  value="{{ $data->target_id }}">{{ $data->target->name }}</option>
                                                <option  disabled ="">-------------------</option>
                                                @foreach ($tag as $d)
                                        ...
                                        <div class="col-md-4">
                                            <div class="card style-2">
                                                <img style="max-height: 220px; min-height: 220px; " src="{{ asset('img/mitra/'.$data->kk_img) }}" class="card-img-top" alt="...">
                                            </div>
                                        </div>
                                         <div class="col-md-4">
                                            <div class="card style-2">
                                                <img style="max-height: 220px; min-height: 220px; " src="{{ asset('img/mitra/'.$data->ktp_img) }}" class="card-img-top" alt="...">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="card style-2">
                                                <img style="max-height: 220px; min-height: 220px; " src="{{ asset('img/mitra/'.$data->npwp_img) }}" class="card-img-top" alt="...">
                                            </div>
                                        </div>
