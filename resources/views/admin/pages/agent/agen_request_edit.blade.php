                        ...
                        <div id="browser_default" class="col-lg-12 layout-spacing col-md-6 mt-4">
                            <div class="statbox widget box box-shadow">
                                <div class="widget-header">
                                    <div class="row">
                                        <div class="col-xl-12 col-md-12 col-sm-12 col-12 mt-2">
                                            <h4>Detail Data Request Mitra - {{ $data->name }}</h4>
                                        </div>                 
                                    </div>
                                </div>
                                ...
                                <div class="widget-content widget-content-area p-4">
                                    ...
                                    @enderror
                                    <form method="POST" action="{{ route('dashboard.userdata.updateagentrequest',[$data->id]) }}" enctype="multipart/form-data" class="row g-3">
                                    @csrf
                                    @method('PUT')
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input id="agent_code" type="text" class="form-control" name="agent_code" required>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <a class="btn btn-warning" href="{{ route('dashboard.userdata.agent.request') }}" role="button">Back</a>
                                        </div>
                                    </form>
                                </div>
