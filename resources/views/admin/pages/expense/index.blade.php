            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area br-8">
                        <form action="{{ route('dashboard.expensedata.filter') }}" method="get">
                            <div class="row py-4 px-4">
                                ...
                                <div class="col-xl-2" style="margin-top: 30px;">
                                    <a class="btn btn-primary btn-lg" href="{{ route('dashboard.expensedata.create') }}" role="button">
                                        <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('dashboard.expensedata.edit', [$item->id]) }}" class="btn btn-outline-primary">
    ...
    @push('after-script')
        <script>
            ...
            downloadBtn.addEventListener('click', function() {
                ...
                var url = "/dashboard/expensedata/expense/excel";
