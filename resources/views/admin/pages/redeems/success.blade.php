            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area br-8">
                        <form action="{{ route('dashboard.redeemdata.success.Filter') }}" method="get">
                            <div class="row py-4 px-4">
                                ...
                                <div class="col-xl-3 col-md-3 mb-4">
                                    <div class="form-group">
                                        <label for="">Total Redeems Success</label>
                    ...
                    <tbody>
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>{{ \Carbon\Carbon::parse($item->redeem_approve_date)->format('d F Y') }}</td>
    ...
    @push('after-script')
        <script>
            ...
            downloadBtn.addEventListener('click', function() {
                ...
                var url = "/dashboard/redeemdata/success/excel";
