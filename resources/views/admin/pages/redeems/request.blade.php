            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <form action="{{ route('dashboard.redeemdata.request.Filter') }}" method="get">
                            <div class="row py-4 px-4">
                                ...
                                <div class="col-xl-3 col-md-3 mb-4" style="margin-top: 30px;">
    ...
    @push('after-script')
        <script>
            ...
            downloadBtn.addEventListener('click', function() {
                ...
                var url = "/dashboard/redeemdata/request/excel";
            ...
            submitCheck.addEventListener('click', function() {
                ...
                var url = "/dashboard/redeemdata/request/submit";
