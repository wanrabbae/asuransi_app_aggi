            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    <div class="widget-content widget-content-area br-8">
                        <form action="{{ route('dashboard.onlinetransaction.process.filter') }}" method="get">
                    ...
                    <tbody>
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('dashboard.onlinetransaction.show', [$item->id]) }}" class="btn btn-outline-primary">
                                        <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"
                                            class="css-i6dzq1">
                                            <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path>
                                        </svg>
                                    </a>
                                    <a class="btn btn-warning" href="" role="button" data-bs-toggle="modal" data-bs-target="#onlinetrxeditModal{{ $item->id }}">
                                        <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"
                                            class="css-i6dzq1">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header mt-2" id="onlinetrxeditModalLabel">
                                            <h4 class="modal-title">Upload Polis Data - {{ $item->nasabah_name }}</h4>
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="{{ route('dashboard.onlinetransaction.update', [$item->id]) }}" enctype="multipart/form-data" class="row g-3">
                                                @csrf
                                                @method('PUT')
                                                <label for="start_date">Masukan No Polis</label>
                                                <div class="form-group">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right">
                                                    <polyline points="9 18 15 12 9 6"></polyline>
                                                </svg>
                                                <input id="no_polis" type="text" class="form-control mb-2" name="no_polis" required>
                                                </div>
                                                <label for="start_date">Upload Polis</label>
                                                <div class="form-group">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                        stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right">
                                                        <polyline points="9 18 15 12 9 6"></polyline>
                                                    </svg>
                                                    <input id="polis" type="file" class="form-control mb-2" name="polis" required>
                                                </div>
                                                <label for="start_date">Upload Nota Premi</label>
                                                <div class="form-group">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                        stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right">
                                                        <polyline points="9 18 15 12 9 6"></polyline>
                                                    </svg>
                                                    <input id="nota_premi" type="file" class="form-control mb-2" name="nota_premi" required>
                                                </div>
                                                <label for="start_date">Upload Nota komisi</label>
                                                <div class="form-group">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                        stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right">
                                                        <polyline points="9 18 15 12 9 6"></polyline>
                                                    </svg>
                                                    <input id="nota_komisi" type="file" class="form-control mb-2" name="nota_komisi">
                                                </div>
    ...
    @push('after-script')
        <script>
            ...
            downloadBtn.addEventListener('click', function() {
                ...
                var url = "/dashboard/onlinetransaction/process/excel";
