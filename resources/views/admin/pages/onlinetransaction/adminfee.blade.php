            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area br-8">
                        <form action="{{ route('dashboard.onlinetransaction.adminfee.filter') }}" method="get">
                            <div class="row py-4 px-4">
                                ...
                                <div class="col-xl-3 mb-4">
                                    <div class="form-group">
                                        <label for="totalincomes">Fee Admin by date</label>
                                ...
                                <div class="col-xl-3 mb-4">
                                    <div class="form-group">
                                        <label for="incomes">Total Fee Admin</label>
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>{{ format_uang($item->biaya_admin) }}</td>
    ...
    @push('after-script')
        <script>
            ...
            downloadBtn.addEventListener('click', function() {
                ...
                var url = "/dashboard/onlinetransaction/adminfee/excel";
