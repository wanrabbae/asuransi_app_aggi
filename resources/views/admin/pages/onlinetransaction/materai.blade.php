            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area br-8">
                        <form action="{{ route('dashboard.onlinetransaction.materai.filter') }}" method="get">
                            <div class="row py-4 px-4">
                                ...
                                <div class="col-xl-2 col-md-2 md-4" style="margin-top: 30px;">
                                ...
                                <div class="col-xl-3 col-md-3 mb-4">
                                    <div class="form-group">
                                        <label for="totalincomes">Materai by date</label>
                                ...
                                <div class="col-xl-3 col-md-3 mb-4">
                                    <div class="form-group">
                                        <label for="incomes">Total Materai</label>
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>{{ format_uang($item->biaya_materai) }}</td>
                                ...
                                <td>
                                    <a href="{{ route('dashboard.onlinetransaction.showfinance', [$item->id]) }}" class="btn btn-outline-primary">
                                        <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"
                                            class="css-i6dzq1">
    ...
    @push('after-script')
        <script>
            ...
            downloadBtn.addEventListener('click', function() {
                ...
                var url = "/dashboard/onlinetransaction/materai/excel";
