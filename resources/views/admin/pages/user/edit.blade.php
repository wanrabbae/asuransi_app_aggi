                        ...
                        <div id="browser_default" class="col-lg-12 layout-spacing col-md-6 mt-4">
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area p-4">
                                    ...
                                    @enderror
                                    <form method="POST" action="{{ route('dashboard.userdata.update',[$data->id]) }}" enctype="multipart/form-data" class="row g-3">
                                    @csrf
                                    @method('PUT')
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input id="referal_code_upline" type="text" class="form-control" name="referal_code_upline" value="{{ $data->referal_code_upline }}">
                                        </div>
                                        <div class="col-md-4">
