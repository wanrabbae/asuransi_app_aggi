                                                ...
                                                <div class="info">
                                                    <div class="col-md-12 mt-1">
                                                        <div class="form-group text-end">
                                                            <a href="{{ route('dashboard.landingdata.editfee', [$d->id]) }}" class="btn btn-outline-primary">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input readonly type="text" class="form-control mb-3 text-white bg-dark" id="admin_fee" name="admin_fee" value="{{ $d->admin_fee }}" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label for="materai_fee">materai Fee</label>
                                                                                    <input readonly type="text" class="form-control mb-3 text-white bg-dark" id="materai_fee" name="materai_fee" value="{{ $d->materai_fee }}" >
                                                                                </div>
                                                                            </div>                                                                                                                     
