            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area br-8">
                        <form action="{{ route('dashboard.offlinetransaction.index.filter') }}" method="get">
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('dashboard.offlinetransaction.request.process', [$item->id]) }}" class="btn btn-info">
                                        process
                                    </a>
                                </td>
                            </tr>
    ...
    @push('after-script')
        <script>
            ...
            downloadBtn.addEventListener('click', function() {
                ...
                var url = "/dashboard/offlinetransaction/excel";
