            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    <div class="widget-content widget-content-area br-8">
                        <form action="{{ route('dashboard.offlinetransaction.completed.filter') }}" method="get">
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/dashboard/offlinetransaction/polis/download/{{ $item->id }}" class="btn btn-outline-warning">
                                        <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"
                                            class="css-i6dzq1">
    ...
    @push('after-script')
        <script>
            ...
            downloadBtn.addEventListener('click', function() {
                ...
                var url = "/dashboard/offlinetransaction/complete/excel";
