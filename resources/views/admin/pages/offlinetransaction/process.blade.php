...
@section('content')
            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area br-8">
                        <form action="{{ route('dashboard.offlinetransaction.process.filter') }}" method="get">
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#onlinetrxeditModal{{ $item->id }}" class="btn btn-success">
                                        payment link
                                    </a>

                                    <!-- Modal Edit -->
                                    <div class="modal fade register-modal" id="onlinetrxeditModal{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="onlinetrxeditModalLabel"
                                        aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">

                                                <div class="modal-header mt-2" id="onlinetrxeditModalLabel">
                                                    <h4 class="modal-title">Kirim Nilai Premi ke {{ $item->nasabah_name }}</h4>
                                                ...
                                                <div class="modal-body">
                                                    <form method="POST" action="{{ route('dashboard.offlinetransaction.process.payment', [$item->id]) }}" enctype="multipart/form-data"
                                                        class="row g-3">
                                                        @csrf
                                                        @method('PUT')
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input placeholder="No Polis" id="no_polis" type="text" class="form-control mb-2" name="no_polis" value="{{ $item->no_polis }}"
                                                                required>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input placeholder="Jatuh Tempo" id="jatuh_tempo" type="date" class="form-control mb-2" name="jatuh_tempo" required>
                                                        </div>
                                                        <label for="polis">Upload File Polis</label>
                                                        <div class="form-group">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right">
                                                                <polyline points="9 18 15 12 9 6"></polyline>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input placeholder="Nilai Premi" id="nilai_premi" type="text" class="form-control mb-2" name="nilai_premi" required>
                                                        </div>
    ...
    @push('after-script')
        ...
        <script>
            var nilai_premi = document.getElementById('nilai_premi');
            nilai_premi.addEventListener('keyup', function(e) {
                nilai_premi.value = formatRupiah(this.value);
            });
            ...
            downloadBtn.addEventListener('click', function() {
                ...
                var url = "/dashboard/offinetransaction/process/excel";
