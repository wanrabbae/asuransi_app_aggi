                        ...
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area br-8">
                                ...
                                <form class="row g-3 px-4">
                                    ...
                                    <div class="col-md-3">
                                        <label for="nilai_pertanggungan" class="col-form-label">Nilai Pertanggungan</label>
                                        <input readonly value="{{ format_uang($data->nilai_pertanggungan) }}" type="text" class="form-control text-white bg-dark" id="nilai_pertanggungan">
                                    </div>
                                    <div class="col-md-12">
                                        <label for="keterangan" class="col-form-label">Keterangan Pertanggungan</label>
                                        <textarea readonly class="form-control text-white bg-dark mb-2" name="keterangan" id="keterangan" rows="6">{{ $data->keterangan }}</textarea>
                                    </div>
                                    @if ($data->status == 6)
                                        <div class="col-md-4">
                                ...
                                <div class="row mb-3 px-4 mt-4">
                                    <div class="col-sm-5">
                                        ...
                                        <a href="/dashboard/offlinetransaction/print/{{ $data->id }}" class="btn btn-primary btn-lg" style="margin-left: 5px;">Print</a>
                                    </div>
                                </div>
