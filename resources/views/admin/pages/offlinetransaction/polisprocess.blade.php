                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header mt-2" id="onlinetrxeditModalLabel">
                                            <h4 class="modal-title">Add Polis Data To {{ $item->nasabah_name }}</h4>
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="{{ route('dashboard.offlinetransaction.update', [$item->id]) }}" enctype="multipart/form-data" class="row g-3">
                                                @csrf
                                                @method('PUT')
                                                <div class="form-group">
    ...
    @push('after-script')
        <script>
            ...
            downloadBtn.addEventListener('click', function() {
                ...
                var url = "/dashboard/offlinetransaction/process/excel";
