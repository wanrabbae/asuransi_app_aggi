            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 ">
                <div class="usr-tasks ">
                    <div class="widget-content widget-content-area">
                        <h4 class="wallet-title">Polis Dibayar</h4>
                            ...
                            <table class="table table-bordered">
                                ...
                                <thead>
                                    <tr class="text-center">
                                        ...
                                        <th>No Transaksi</th>
                                        <th>No Pembayaran</th>
                                        <th width="18%">Tanggal Pembayaran</th>
                                ...
                                <tbody>
                                    @foreach ($polises as $item)
                                        <tr class="text-center">
                                            ...
                                            <td>{{ $item->payment->ipaymu_trx_id }}</td>
                                            <td>{{ \Carbon\Carbon::parse($item->payment->update_at)->format('d F Y') }}</td>
                                            <td>Dibayar</td>
                                            <td>
