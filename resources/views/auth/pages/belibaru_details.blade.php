        ...
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 ">
                <div class="usr-tasks ">
                    ...
                    <div lass="widget-content widget-content-area" id="showloading">
                        <h2 class="text-center">Sedang memproses Asuransi...</h2>
                    </div>
                    <div id="showValidation" class="text-white">
                    </div>

                    @if ($onlineproduct->id == '1')
                        <div id="wizard_Default" class="widget-content widget-content-area">
                                ...
                                <div class="container mb-4">
                                    <form id="insuranceForm" action="/transaction-bangunan" method="POST">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-8">
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea style="resize: none;" class="form-control" rows="7" id="alamatRumah" name="address_bangunan"></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="mb-3">
                                        ...
                                        <div id="step2" class="step">
                                            ...
                                            <hr class="my-4">
                                            @if (auth()->check())
                                                <span class="fs-12">(masukan email dan data anda yang terdaftar)
                                            @endif
                                            </span>
                                            <div class="row gx-4">
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-8">
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea style="resize: none;" class="form-control" rows="7" id="alamatNasabah" name="nasabah_address"></textarea>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="card shadow-none bg-pale-blue">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row gx-4">
                                                                ...
                                                                <div class="col-md-4 col-12">
                                                                    <span class="card-text">Kalurahan</span>
                                                                </div>
                                                                <div class="col-md-8 col-12">
                            ...
                            <div class="widget-header">
                                <div class="container mb-4">
                                    <form id="insuranceForm" action="/transaction-kecelakaan" method="POST">
                                        ...
                                        <div id="step1" class="step">
                                            <hr class="my-4">
                                            <h3 class="mb-4"><span class="icon btn btn-circle btn-md btn-primary pe-none mb-1"><span class="number">01</span></span> Informasi Tertanggung</h3>
                                            <hr class="my-4">

                                            <div class="row gx-4">
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        <label for="pekerjaanTertanggung" class="form-label">Pekerjaan</label>
                                                        <select class="form-select" id="pekerjaanTertanggung" name="tertanggung_work">
                                                            <option value="Ahli Bedah"></option>Ahli Bedah</option>
                                                            <option value="Aktris/Aktor">Aktris/Aktor</option>
                                                            <option value="Akuntan">Akuntan</option>
                                                            <option value="Anak Buah Kapal (ABK)">Anak Buah Kapal (ABK)</option>
                                                            <option value="Apoteker">Apoteker</option>
                                                            <option value="Arsitek">Arsitek</option>
                                                            <option value="Bidan - Non Bedah">Bidan - Non Bedah</option>
                                                            <option value="Buruh Pabrik">Buruh Pabrik</option>
                                                            <option value="Desainer">Desainer</option>
                                                            <option value="Dokter - Non Bedah">Dokter - Non Bedah</option>
                                                            <option value="Dosen">Dosen</option>
                                                            <option value="Editor">Editor</option>
                                                            <option value="Fotografer">Fotografer</option>
                                                            <option value="Guru">Guru</option>
                                                            <option value="Ibu rumah tangga">Ibu rumah tangga</option>
                                                            <option value="Insinyur - Non Lapangan">Insinyur - Non Lapangan</option>
                                                            <option value="Insinyur/Engineer Lapangan">Insinyur/Engineer Lapangan</option>
                                                            <option value="Jaksa">Jaksa</option>
                                                            <option value="Jasa Keuangan - Collector">Jasa Keuangan - Collector</option>
                                                            <option value="Jasa Keuangan - Non Collector">Jasa Keuangan - Non Collector</option>
                                                            <option value="Jurnalis/Wartawan">Jurnalis/Wartawan</option>
                                                            <option value="Karyawan Swasta">Karyawan Swasta</option>
                                                            <option value="Karyawan Penebang Kayu">Karyawan Penebang Kayu</option>
                                                            <option value="Kasir">Kasir</option>
                                                            <option value="Koki">Koki</option>
                                                            <option value="Kondektur">Kondektur</option>
                                                            <option value="Konsultan">Konsultan</option>
                                                            <option value="Logistik - Purchasing">Logistik - Purchasing</option>
                                                            <option value="Logistik - Warehouse">Logistik - Warehouse</option>
                                                            <option value="Mahasiswa">Mahasiswa</option>
                                                            <option value="Manager Pelaksana">Manager Pelaksana</option>
                                                            <option value=Montir/Mekanik">Montir/Mekanik</option>
                                                            <option value="Nelayan/Perikanan">Nelayan/Perikanan</option>
                                                            <option value="Notaris">Notaris</option>
                                                            <option value="Pegawai Negeri Sipil">Pegawai Negeri Sipil</option>
                                                            <option value="Pegawai Bank - Collector">Pegawai Bank - Collector</option>
                                                            <option value="Pegawai Bank - Non Collector">Pegawai Bank - Non Collector</option>
                                                            <option value="Pegawai kantor Pemerintahan">Pegawai kantor Pemerintahan</option>
                                                            <option value="Pegawai Kantoran">Pegawai Kantoran</option>
                                                            <option value="Pegawai Leasing - Collector">Pegawai Leasing - Collector</option>
                                                            <option value="Pegawai Leasing-Non Collector">Pegawai Leasing-Non Collector</option>
                                                            <option value="Pekerja Tambang">Pekerja Tambang</option>
                                                            <option value="Pelajar">Pelajar</option>
                                                            <option value="Pelaksana Lapangan">Pelaksana Lapangan</option>
                                                            <option value="Pelayan Toko/Restoran">Pelayan Toko/Restoran</option>
                                                            ...
                                                            <option value="Perawat - Non Bedah">Perawat - Non Bedah</option>
                                                            <option value="Perternak">Perternak</option>
                                                            <option value="Perternak Hewan Buas">Perternak Hewan Buas</option>
                                                            ...
                                                            <option value="Salesman/Marketing">Salesman/Marketing</option>
                                                            <option value="Satpam/Security Kantor">Satpam/Security Kantor</option>
                                                            <option value="Satpam/Security Lapangan">Satpam/Security Lapangan</option>
                                                            <option value="Sekretaris">Sekretaris</option>
                                                            <option value="Seniman">Seniman</option>
                                                            <option value="Supir Angkutan Umum">Supir Angkutan Umum</option>
                                                            <option value="Supir Pribadi">Supir Pribadi</option>
                                                            <option value="Surveyor">Surveyor</option>
                                                            <option value="Teknisi Listrik">Teknisi Listrik</option>
                                                            <option value="Teknisi Sipil">Teknisi Sipil</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="namaLengkapTertanggung" class="form-label">Nama Lengkap</label>
                                                        <input type="text" class="form-control" id="namaLengkapTertanggung" value="{{ old('tertanggung_name') }}" name="tertanggung_name">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        <label for="nomorKTPTertanggung" class="form-label">Nomor KTP (Minimal 12 digits)</label>
                                                        <input type="number" class="form-control" id="nomorKTPTertanggung" name="tertanggung_id">
                                                    </div>
                                                </div>

                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        <label for="emailTertanggung" class="form-label">Email</label>
                                                        <input type="text" class="form-control" id="emailTertanggung" value="{{ old('tertanggung_email') }}" name="tertanggung_email">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        <label for="phoneTertanggung" class="form-label">No. Telp</label>
                                                        <input placeholder="dimulai dari angka 0 (08xxx)" type="number" class="form-control" id="phoneTertanggung" value="{{ old('tertanggung_phone') }}"
                                                            name="tertanggung_phone">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        <label for="tempatLahirTertanggung" class="form-label">Tempat Lahir</label>
                                                        <input type="text" class="form-control" id="tempatLahirTertanggung" name="tertanggung_pob">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        <label for="tanggalLahirTertanggung" class="form-label">Tanggal Lahir</label>
                                                        <input type="date" class="form-control" id="tanggalLahirTertanggung" name="tertanggung_dob">
                                                    </div>
                                                </div>
                                                <div class="col-xl-12 mx-auto">
                                                    <div class="row">
                                                        <div class="col-lg-8">
                                                            <div class="mb-3">
                                                                <label for="alamatRumahTertanggung" class="form-label">Alamat Tertanggung</label>
                                                                <textarea style="resize: none;" class="form-control" rows="6" id="alamatRumahTertanggung" name="tertanggung_address"></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="mb-3">
                                                                <label for="provinsiTertanggung" class="form-label">Kota & Provinsi</label>
                                                                <select class="form-select" id="provinsiTertanggung" name="tertanggung_province">
                                                                    <option value="" selected>Pilih Provinsi</option>
                                                                </select>
                                                            </div>
                                                            <div class="mb-3">
                                                                <select class="form-select" id="kotaTertanggung" name="tertanggung_city">
                                                                    <option value="" selected>Pilih Kota</option>
                                                                </select>
                                                            </div>
                                                            <div class="mb-3">
                                                                <select class="form-select" id="kecamatanTertanggung" name="tertanggung_district">
                                                                    <option value="" selected>Pilih Kecamatan</option>
                                                                </select>
                                                            </div>
                                                            <div class="mb-3">
                                                                <select class="form-select" id="kodePosTertanggung" name="tertanggung_poscode">
                                                                    <option value="">Pilih Kelurahan - Kode Pos</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                        ...
                                        <div id="step2" class="step">
                                            <hr class="my-4">
                                            <h3 class="mb-4"><span class="icon btn btn-circle btn-md btn-primary pe-none mb-1"><span class="number">02</span></span> Informasi Penanggung</h3>
                                            <hr class="my-4">
                                        ...
                                        <div id="step3" class="step">
                                            <hr class="my-4">
                                            <h3 class="mb-4"><span class="icon btn btn-circle btn-md btn-primary pe-none mb-1"><span class="number">03</span></span> Ahli Waris</h3>
                                            <hr class="my-4">
                                            ...
                                            <div id="ahliWarisContainer">
                                                <div class="ahli-waris-container">
                                                    <div class="row gx-4" id="ahliWaris1">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="mb-3">
                                                                <label for="nomorIdentitasAhliWaris1" class="form-label">Nomor Identitas Ahli Waris (Optional)</label>
                                        ...
                                        <div id="step4" class="step">
                                            ...
                                            <input type="hidden" name="product_id" value="{{ $onlineproduct->id }}">
                                            <hr class="my-4">
                                            <h3 class="mb-4"><span class="icon btn btn-circle btn-md btn-primary pe-none mb-1"><span class="number">04</span></span> Cara Pembayaran</h3>
                                            <hr class="my-4">
                                            ...
                                            <div class="row gx-md-12 gx-xl-12 gy-12" id="summaryContainer">
                                                <div class="col-lg-8">
                                                    <div class="card shadow-none bg-pale-blue">
                                                        <div class="card-body">
                                                            <h5>Informasi Tertanggung</h5>
                                                            <div class="row gx-4 mb-4">
                                                                <div class="col-md-4">
                                                                    <span class="card-text">Nama Lengkap</span>
                                                                </div>
                                                                <div class="col-md-8">
                                                                    - <span id="summaryNamaLengkapTertanggung"></span>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <span class="card-text">Nomor KTP</span>
                                                                </div>
                                                                <div class="col-md-8">
                                                                    - <span id="summaryNomorKTPTertanggung"></span>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <span class="card-text">Tanggal Lahir</span>
                                                                </div>
                                                                <div class="col-md-8">
                                                                    - <span id="summaryTanggalLahirTertanggung"></span>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <span class="card-text">Alamat</span>
                                                                </div>
                                                                <div class="col-md-8">
                                                                    - <span id="summaryAlamatNasabahTertanggung"></span>
                                                                </div>
                                                                <div class="col-md-4 col-12">
                                                                    <span class="card-text">Kabupaten / Kota</span>
                                                                </div>
                                                                <div class="col-md-8 col-12">
                                                                    - <span id="summaryKotaTertanggung"></span>
                                                                </div>
                                                                <div class="col-md-4 col-12">
                                                                    <span class="card-text">Kecamatan</span>
                                                                </div>
                                                                <div class="col-md-8 col-12">
                                                                    - <span id="summaryKecamatanTertanggung"></span>
                                                                </div>                                                            
                                                                <div class="col-md-4 col-12">
                                                                    <span class="card-text">Kelurahan</span>
                                                                </div>
                                                                <div class="col-md-8 col-12">
                                                                    - <span id="summaryKelurahanTertanggung"></span>
                                                                </div>
                                                                <div class="col-md-4 col-12">
                                                                    <span class="card-text">Provinsi</span>
                                                                </div>
                                                                <div class="col-md-8 col-12">
                                                                    - <span id="summaryProvinsiTertanggung"></span>, <span id="summaryKodePosTertanggung"></span>
                                                                </div>                                                            
                                                            </div>
                                                            <h5>Informasi Penanggung</h5>
                                                            <div class="row gx-4 mb-4">
                                                                <div class="col-md-4">
                                                                    <span class="card-text">Nama Lengkap</span>
                                                                </div>
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <button type="submit" class="btn btn-primary next-btn btn-sm rounded w-100 mt-4 paymentProcess" disabled>Proses Pembayaran</button>
                                                    <button type="button" class="btn btn-primary prev-btn btn-sm rounded w-100 mt-2">Kembali</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
    ...
    @push('after-script')
        ...
        @if ($onlineproduct->id == '2')
            <script>
                fetch('/api/address/provinces')
                    ...
                    .then((data) => {
                        ...
                        for (let i = 0; i < provinsiLength; i++) {
                            ...
                            option.value = data[i].id_province + '-' + data[i].name_province;
                            option.textContent = data[i].name_province;
                            provinsiTertanggung.appendChild(option);
                            provinsiNasabah.appendChild(option.cloneNode(true));
                        }
                    })
                    .catch((err) => {
                ...
                $('#kecamatanNasabah').on('change', function() {
                    ...
                    fetch('/api/address/postcode/' + kecamatanId.split('-')[1])
                        ...
                        .then((data) => {
                            var kodePos = document.getElementById('kodePosNasabah');
                            kodePos.innerHTML = `
                                <option value="" selected>Pilih Kelurahan - Kode Pos</option>
                            `
                            var kodePosLength = data.length;
                            for (let i = 0; i < kodePosLength; i++) {
                                var option = document.createElement('option');
                                option.value = data[i].name_villages + '-' + data[i].poscode;
                                option.textContent = data[i].poscode + ' - ' + data[i].name_districts + ', ' + data[i].name_villages;
                                kodePos.appendChild(option);
                            }
                            // default selected first option
                ...
                $('#provinsiTertanggung').on('change', function() {
                    console.log('provinsi changed');
                    var provinsiId = this.value;
                    $('#kotaTertanggung').empty();
                    fetch('/api/address/regencies/' + provinsiId)
                        .then((response) => {
                            return response.json();
                        })
                        .then((data) => {
                            var kota = document.getElementById('kotaTertanggung');
                            kota.innerHTML = `
                                <option value="" selected>Pilih Kota</option>
                            `
                            var kotaLength = data.length;
                ...
                $('#kotaTertanggung').on('change', function() {
                    $('#kecamatanTertanggung').empty();
                    console.log("test kota");
                    var kotaId = this.value;
                    console.log(kotaId);
                    fetch('/api/address/districts/' + kotaId)
                        ...
                        .then((data) => {
                            var kecamatan = document.getElementById('kecamatanTertanggung');
                            kecamatan.innerHTML = `
                                <option value="" selected>Pilih Kecamatan</option>
                            `
                            var kecamatanLength = data.length;
                ...
                $('#kecamatanTertanggung').on('change', function() {
                    $('#kodePosTertanggung').empty();
                    var kecamatanId = this.value;
                    console.log(kecamatanId.split('-')[1]);
                    fetch('/api/address/postcode/' + kecamatanId.split('-')[1])
                        .then((response) => {
                        ...
                        .then((data) => {
                            var kodePos = document.getElementById('kodePosTertanggung');
                            kodePos.innerHTML = `
                                <option value="" selected>Pilih Kelurahan - Kode Pos</option>
                            `
                            var kodePosLength = data.length;
            ...
            $(document).ready(function() {
                ...
                if (isLogin == '1') {
                    ...
                    if (typeInsurance == '1') {
                        ...
                        $('#pekerjaanTertanggung').val(readValueLocalStorage('pekerjaanTertanggung'));
                        $('#namaLengkapTertanggung').val(readValueLocalStorage('namaLengkapTertanggung'));
                        $('#nomorKTPTertanggung').val(readValueLocalStorage('nomorKTPTertanggung'));
                        $('#emailTertanggung').val(readValueLocalStorage('emailTertanggung'));
                        $('#phoneTertanggung').val(readValueLocalStorage('phoneTertanggung'));
                        $('#tempatLahirTertanggung').val(readValueLocalStorage('tempatLahirTertanggung'));
                        $('#tanggalLahirTertanggung').val(readValueLocalStorage('tanggalLahirTertanggung'));
                        $('#alamatRumahTertanggung').val(readValueLocalStorage('alamatRumahTertanggung'));
                    }
                }
                ...
                $('#provinsiTertanggung').select2({
                    theme: 'bootstrap'
                });
                $('#kotaTertanggung').select2({
                    theme: 'bootstrap'
                });
                $('#kecamatanTertanggung').select2({
                    theme: 'bootstrap'
                });
                $('#kodePosTertanggung').select2({
                    theme: 'bootstrap'
                });
                ...
                function validateStep(step) {
                    ...
                    if (typeInsurance == '2') {
                        if (step === 1) {
                            ...
                            isValid = validateStep3KecelakaanFields();
                        }
                        // Add additional validation logic for other steps as needed
                    ...
                    function validateStep2KebakaranFields() {
                        ...
                        if (phone.charAt(0) != 0) {
                            $('#showValidation').html('<div class="alert alert-danger bg-danger p-2 text-white" role="alert">Nomor telepon harus diawali dengan 0.</div>');
                            return false;
                        }
                    ...
                    function validateStep1KecelakaanFields() {
                        var namaLengkapTertanggung = $("#namaLengkapTertanggung").val();
                        var nomorKTPTertanggung = $("#nomorKTPTertanggung").val();
                        var tanggalLahirTertanggung = $("#tanggalLahirTertanggung").val();
                        var alamatRumahTertanggung = $("#alamatRumahTertanggung").val();
                        var tempatLahirTertanggung = $("#tempatLahirTertanggung").val();
                        var phoneTertanggung = $("#phoneTertanggung").val();
                        var emailTertanggung = $("#emailTertanggung").val();
                        // Add more fields as needed
                        var provinsiTertanggung = $("#provinsiTertanggung").val();
                        var kotaTertanggung = $("#kotaTertanggung").val();
                        var kecamatanTertanggung = $("#kecamatanTertanggung").val();
                        var kodePosTertanggung = $("#kodePosTertanggung").val();

                        // Example validation, you can customize based on your requirements
                        if (namaLengkapTertanggung === "" || nomorKTPTertanggung === "" || tanggalLahirTertanggung === "" || alamatRumahTertanggung === "" || tempatLahirTertanggung === "" ||
                            phoneTertanggung === "" || emailTertanggung === "" || provinsiTertanggung === "" || kotaTertanggung === "" || kecamatanTertanggung === "" || kodePosTertanggung === ""
                        ) {
                            $('#showValidation').html('<div class="alert alert-danger bg-danger p-2 text-white" role="alert">Isi data "Informasi Tertanggung" secara lengkap.</div>');
                            return false;
                        }
                        // check if nomorKTPTertanggung.length > 12
                        if (nomorKTPTertanggung.length < 12) {
                            $('#showValidation').html('<div class="alert alert-danger bg-danger p-2 text-white" role="alert">Nomor KTP minimal 12 digit.</div>');
                            return false;
                        }
                        ...
                        // validate email
                        var emailRegex = /\S+@\S+\.\S+/;
                        if (!emailRegex.test(emailTertanggung)) {
                            $('#showValidation').html('<div class="alert alert-danger bg-danger p-2 text-white" role="alert">Email tidak valid.</div>');
                            return false;
                        }

                        // check if phone start with 0
                        if (phoneTertanggung.charAt(0) != 0) {
                            $('#showValidation').html('<div class="alert alert-danger bg-danger p-2 text-white" role="alert">Nomor telepon harus diawali dengan 0.</div>');
                            return false;
                        }
                        ...
                        // check if tanggal lahir is > 17 years
                        var today = new Date();
                        var birthDate = new Date(tanggalLahirTertanggung);
                        var age = today.getFullYear() - birthDate.getFullYear();
                        var m = today.getMonth() - birthDate.getMonth();
                        if (m < 0 || (m === 0 && today.getDate() < birthDate.getDate())) {
                            age--;
                    ...
                    function validateStep3KecelakaanFields() {
                        ...
                        for (let i = 0; i < ahliWarisContainer.length; i++) {
                            ...
                            if (namaAhliWaris === "" || hubunganStatusAhliWaris === "" || emailAhliWaris === "" || ttlAhliWaris === "" || tglAhliWaris === "") {
        ...
        <script>
            $(document).ready(function() {
                ...
                function updateSummary() {
                    ...
                    // Step 1
                    $('#summaryNamaLengkapTertanggung').text($('#namaLengkapTertanggung').val());
                    $('#summaryNomorKTPTertanggung').text($('#nomorKTPTertanggung').val());
                    $('#summaryTanggalLahirTertanggung').text(formatTanggal($('#tanggalLahirTertanggung').val()));
                    $('#summaryAlamatNasabahTertanggung').text($('#alamatRumahTertanggung').val());
                    ...
                    if (type == '1') {
                        ...
                        $('#summaryProvinsiTertanggung').text($('#provinsiTertanggung').val()?.toString()?.split('-')[1]);
                        $('#summaryKotaTertanggung').text($('#kotaTertanggung').val()?.toString()?.split('-')[1]);
                        $('#summaryKecamatanTertanggung').text($('#kecamatanTertanggung').val()?.toString()?.split('-')[1]);
                        $('#summaryKelurahanTertanggung').text($('#kodePosTertanggung').val()?.toString()?.split('-')[0]);
                        $('#summaryKodePosTertanggung').text($('#kodePosTertanggung').val()?.toString()?.split('-')[1]);
                    }
