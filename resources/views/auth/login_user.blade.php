...
<body class="form">
                    ...
                    <div class="col-6 d-lg-flex d-none h-100 my-auto top-0 start-0 text-center justify-content-center flex-column">
                        ...
                        <div class="auth-cover">
                            ...
                            <div class="position-relative">
                                ...
                                <!--<img src="{{ asset('/img/landing') }}/logo-01.png" alt="auth-img">-->

                                <h2 class="mt-5 text-white font-weight-bolder px-2">AGGIKU</h2>
                                <p class="text-white px-2">It is easy to join with  AGGIKU</p>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <input type="hidden" name="payment_link" id="payment_link">
                                    <div class="col-12">
                                        <div class="mb-4">
    ...
    <script>
        document.getElementById('payment_link').value = localStorage.getItem('payment_link');
    </script>
</body>
